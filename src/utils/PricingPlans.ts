...
const PaidPlans: PricingPlan[] = [
  {
    ...
    price: 79,
    // TODO: colle ici le variant_id réel du produit "Premium" créé dans ton dashboard Lemon Squeezy
    lemonSqueezyVariantId: '',
    limits: {
      teamMember: 5,
      website: 5,
  ...
  },
  {
    ...
    price: 199,
    // TODO: colle ici le variant_id réel du produit "Enterprise" créé dans ton dashboard Lemon Squeezy
    lemonSqueezyVariantId: '',
    limits: {
      teamMember: 100,
      website: 100,
